...
export const StravaActivityMap: React.FC<StravaActivityMapProps> = ({
  ...
  if (status === 'error') {
    return (
      <div className={`flex items-center justify-center h-full bg-theme-secondary/50 rounded-xl ${className}`}>
  ...
  return (
    <div className={`relative h-full ${className}`}>
      {status === 'loading' && (
        <div className="absolute inset-0 flex items-center justify-center bg-theme-tertiary/80 z-10 rounded-xl">
