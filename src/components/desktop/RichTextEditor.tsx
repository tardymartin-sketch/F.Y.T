...
export const RichTextEditor: React.FC<Props> = ({ 
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-invert prose-sm max-w-none p-4 min-h-[150px] focus:outline-none text-theme',
      },
    },
    onUpdate: ({ editor }) => {
  ...
  if (!editor) {
    return (
      <div className="bg-theme border border-theme rounded-xl overflow-hidden">
        <div className="p-4 min-h-[150px] animate-pulse bg-theme-secondary" />
      </div>
    );
  }
  ...
  return (
    <div className="bg-theme border border-theme rounded-xl overflow-hidden focus-within:border-blue-500 transition-colors">
      {/* Toolbar */}
