...
export const HistoryDesktop: React.FC<Props> = ({
  ...
  return (
    <div className="h-full flex flex-col bg-theme">
      ...
      <div className="flex gap-4 p-4" style={{ height: 'calc(100% - 88px)' }}>
        {/* ========== ZONE LISTE (40%) ========== */}
        <div className="w-2/5 bg-theme-secondary/50 border border-theme rounded-xl flex flex-col overflow-hidden">
          ...
          <div
            ...
            className="flex-1 min-h-0 overflow-y-auto custom-scrollbar px-3 pb-3 space-y-4"
          >
            {history.length === 0 ? (
              ...
              // Mode recherche : afficher les exercices correspondants
              ...
              // Mode normal : afficher les séances groupées
        ...
        {/* ========== ZONE VISUALISATION (60%) ========== */}
        <div className="w-3/5 bg-theme-secondary/50 border border-theme rounded-xl overflow-y-auto custom-scrollbar">
          {renderDetailPanel()}
        </div>
      </div>

      {/* Delete Confirmation Modal (Popover en desktop) */}
      {deleteConfirm && (() => {
      ...
      {/* Edit Confirmation Modal (Popover en desktop) */}
      {editConfirm && (() => {
