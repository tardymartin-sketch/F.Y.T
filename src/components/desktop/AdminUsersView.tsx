    ...
    <div className="space-y-6 animate-fade-in">
      <div className="pl-12">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-theme">Administration</h1>
            <p className="text-theme-muted mt-1">Gestion des utilisateurs et des rôles</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-theme-secondary border border-theme rounded-xl text-theme placeholder-theme-muted focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      ...
      <div className="bg-theme-secondary border border-theme rounded-2xl overflow-hidden">
        {loading && users.length === 0 ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-theme-muted">Aucun utilisateur trouvé</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-theme-tertiary/50">
                <tr className="text-left text-sm text-theme-muted">
              ...
              <tbody className="divide-y divide-theme">
                {filteredUsers.map((user) => {
                  ...
                  return (
                    <tr key={user.id} className="hover:bg-theme-tertiary/30 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-theme-tertiary rounded-xl flex items-center justify-center text-theme-muted font-medium">
                      ...
                      <td className="px-6 py-4">
                        {isEditing ? (
                          <select
                            ...
                            className="bg-theme-tertiary border border-theme rounded-lg px-3 py-2 text-theme text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                          >
                        ...
                        {isEditing ? (
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="p-2 bg-theme-tertiary text-theme-muted rounded-lg hover:bg-theme-secondary transition-colors"
                            >
                              <X className="w-4 h-4" />
                            </button>
                          </div>
