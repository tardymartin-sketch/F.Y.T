    ...
    <button
      ...
      className={`
        ...
        ${badge.isUnlocked
          ...
          : 'bg-theme-tertiary border border-theme opacity-40 grayscale'
        }
      `}
      title={badge.name}
    >
      ...
      {Array.from({ length: total }).map((_, i) => (
        <span
          ...
          className={`w-2 h-2 rounded-full ${
            i < unlocked ? color.replace('text-', 'bg-') : 'bg-theme-tertiary'
          }`}
        />
      ))}
      ...
      <div className={`bg-theme-secondary border border-theme rounded-2xl overflow-hidden ${className}`}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-theme">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-theme">Mes Badges</h3>
          ...
          <button
            ...
            className="flex items-center gap-1 text-sm text-[var(--color-primary)] hover:opacity-80 transition-colors"
          >
