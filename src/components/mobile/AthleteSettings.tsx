...
const Toggle: React.FC<ToggleProps> = ({
  ...
  return (
    <div className="flex items-start gap-4 py-4 border-b border-theme last:border-b-0">
      {/* Icon */}
      ...
      <div className="flex-1 min-w-0">
        <h4 className="text-theme font-medium">{label}</h4>
      ...
      <button
        ...
        className={`
          ...
          ${checked ? 'bg-[var(--color-primary)]' : 'bg-theme-tertiary'}
        `}
      >
        <span
          className={`
  ...
  return (
    <div className={`bg-theme-secondary border border-theme rounded-2xl overflow-hidden ${className}`}>
      ...
      <div className="flex items-center gap-3 p-4 border-b border-theme">
        ...
        <h3 className="text-lg font-semibold text-theme">Préférences d'entraînement</h3>
      </div>
      ...
      <div className="px-4">
        <Toggle
          ...
          icon={<Clock className="w-5 h-5 text-theme-muted" />}
