  ...
  if (data.length === 0 || !stats) {
    return (
      <div className="bg-theme-secondary/50 border border-theme rounded-xl p-8 text-center">
        ...
        <p className="text-theme-muted">Aucune donnée de volume disponible</p>
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 pt-3 border-t border-theme grid grid-cols-3 gap-4 text-sm text-center">
        <div>
          <span className="text-theme-muted block">Total</span>
          <span className="text-theme font-medium">{formatVolume(stats.totalVolume)}</span>
        </div>
        <div>
          <span className="text-theme-muted block">Moyenne/jour</span>
          <span className="text-[var(--color-primary)] font-medium">{formatVolume(stats.avgVolume)}</span>
        </div>
        <div>
          <span className="text-theme-muted block">Max</span>
          <span className="text-theme font-medium">{formatVolume(stats.maxVolume)}</span>
        </div>
      </div>
    </div>
  );
